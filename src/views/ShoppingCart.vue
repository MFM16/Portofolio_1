...
export default {
  ...
  methods: {
    ...
    checkOut() {
      ...
      axios
        ...
        .then(console.log(this.checkoutData))
        .catch((err) => console.log(this.checkoutData, err));
    },
  },
  mounted() {
  ...
  computed: {
    ...
    totalBiaya() {
      return this.totalHarga + this.totalPajak;
    },
  },
};
</script>
